...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { description: @dog.description, is_neuter: @dog.is_neuter, name: @dog.name, sex: @dog.sex }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { description: @dog.description, is_neuter: @dog.is_neuter, name: @dog.name, sex: @dog.sex }
    assert_redirected_to dog_path(assigns(:dog))
  end
