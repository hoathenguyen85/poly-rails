...
class FishControllerTest < ActionController::TestCase
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post :create, fish: { description: @fish.description, is_neuter: @fish.is_neuter, name: @fish.name, sex: @fish.sex }
    end
  ...
  test "should update fish" do
    patch :update, id: @fish, fish: { description: @fish.description, is_neuter: @fish.is_neuter, name: @fish.name, sex: @fish.sex }
    assert_redirected_to fish_path(assigns(:fish))
  end
