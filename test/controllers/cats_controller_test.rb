...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { description: @cat.description, dog: @cat.dog, fish: @cat.fish, is_neuter: @cat.is_neuter, name: @cat.name, sex: @cat.sex }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { description: @cat.description, dog: @cat.dog, fish: @cat.fish, is_neuter: @cat.is_neuter, name: @cat.name, sex: @cat.sex }
    assert_redirected_to cat_path(assigns(:cat))
  end
